      ...
      <label htmlFor={inputId} className="relative cursor-pointer group">
        ...
        >
          ...
          <input
            type="color"
            id={inputId}
            value={currentColorValue || "#000000"} // Input needs a value, even if not visually used for the swatch itself
            onChange={onColorChange}
            className="absolute opacity-0 w-0 h-0 pointer-events-none" // Visually hidden but functional
          />
        </div>
      </label>
